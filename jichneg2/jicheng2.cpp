...
public:
	CLiGang();
	CLiGang(int y, int m, int d, int h, int mi, int s, int mis);
	~CLiGang() {
		cout << "被调用了" << endl;
	}
	void print();
...
public:
	LiGang();
	LiGang(int y, int m, int d, int h, int mi, int s, int mis);
	~LiGang() {
		cout << "被调用了" << endl;
	}
	void print();
...
CLiGang::CLiGang(int y, int m, int d, int h, int mi, int s, int mis) {
	Year = y;
	Month = m;
	Day = d;
	Hour = h;
...
int CLiGang::BackMinute() {
	return Minute;
}
int CLiGang::BackSecond() {
	return Second;
}
int CLiGang::BackMilliSecond() {
	return MilliSecond;
}
int CLiGang::check() {
...
int CLiGang::SetDays(int y, int m, int d, int h, int mi, int s, int mis) {
	Year = y;
	Month = m;
	Day = d;
	Hour = h;
...
int main() {
	int count = 1;
	CLiGang oj(2019, 12, 30, 72, 0, 0, 0);
